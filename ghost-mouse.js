...
(function() {
  var GhostMouse, getOffset, killEvent, mouseDisabler, mousePosition, updateMousePosition, wait,
    __slice = [].slice;
  ...
  GhostMouse = (function() {
    ...
    GhostMouse.prototype._reset = function() {
      var bodyMargin, bodyRect, cb, duration, _arg, _j;
